				...
				<Row>
					<Col md={12} className="dashboardCards pt-5">
						...
						<div className="d-flex">
							...
							<Dropdown>
								<Dropdown.Toggle className="drop-btn pt-0 pl-5">New York</Dropdown.Toggle>
								<Dropdown.Menu>
									<Dropdown.Item href="#/action-1">Action</Dropdown.Item>
									<Dropdown.Item href="#/action-2">Another action</Dropdown.Item>
									<Dropdown.Item href="#/action-3">Something else</Dropdown.Item>
					...
					<Col md={4}>
						<Card className="mt-4">
							<Card.Body>
								...
								<Card.Text>Add clients, edit clients info and view history.</Card.Text>
							</Card.Body>
						</Card>
					</Col>
					<Col md={4}>
						<Card className="mt-4">
							<Card.Body>
								...
								<Card.Text>View status, download signed forms and send reminders</Card.Text>
							</Card.Body>
						</Card>
					</Col>
					<Col md={4}>
