...
const ContactDetail = (props) => {
	...
	const handleContact = async () => {
		...
		try {
			const getContactData = await API.graphql(
				graphqlOperation(getContact, {
							...
							<Card className="pb-0 about-detail mb-4">
								...
								<Accordion.Collapse eventKey="0">
									<Card.Body>
										...
										<div className="border-bottom py-3">
											<p>
												<Link to="#">1000 Biscayne Blvd, Miami, FL 35413</Link>
											</p>
										...
										<div className="border-bottom py-3 mb-3">
											<p>
												<Link to="#">4888 Collins Ave, Apt 23, Miami, FL</Link>
											</p>
					...
					<Col md={8} className="detail-contact-right px-5">
						<div className="d-flex">
							<Dropdown className="pt-4">
								<Dropdown.Toggle className="drop-btn pt-0 pl-0">History</Dropdown.Toggle>
							...
							<Dropdown className="pt-4 ml-auto">
								<Dropdown.Toggle className="drop-btn pt-0">Filter</Dropdown.Toggle>
						...
						<div className="border-bottom pt-4 pb-2">
							...
							<p className="my-2 mt-3">
								You created a<Link to="#">buyer deal at TBD</Link>with John Smith
							</p>
