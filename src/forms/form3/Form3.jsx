...
const Form3 = ({ formData, viewMode, onFormSubmission }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      realEstateName: Yup.string().required(
        "Please enter the Real Estate Name"
      ),
      realEstateBrokerageCompany: Yup.string().required(
        "Please enter the Real Estate Company"
      ),
    }),
    onSubmit: (values) => {
          ...
          <Col md={12} className="pt-5">
            <p>
              <span>
                ...
                attending any in-person property showings and/or meetings with
                the undersigned real estate licensee (the “Broker”). This Form
                shall be distributed to all attendees within 24 hours of any
                scheduled meeting. Please understand that the purpose of this
                Form is to elicit information to help promote the health and
                safety of all persons who may be involved in the meeting and/or
                showing, and that taking precautionary measures to prevent the
                spread of the Coronavirus (COVID-19) is paramount to those
                efforts{" "}
              </span>
            </p>
            <p>
              ...
              indication that a person who is attending the showing or meeting
              is exhibiting any{" "}
            ...
            <p>
              ...
              whether an in-person showing or meeting can occur, (iii) the
              refusal or failure to answer each question below may result in the
              ...
              refuse entry to that person; (iv) if the answer to questions 1-3
              is “Yes” that person will not be permitted to attend the in-person
              showing or meeting; (v) if the answer to question 4 is “Yes” and
              the answer to question 4a is “No” that person will not be
              permitted to attend the in-person showing or meeting; (vi) if the
              answer to question 5 is “Yes” and the answer to question 5a is
              “No” that person will not be permitted to attend the in-person
              showing or meeting; (vii) any person may be asked in the future to
              execute another Form in connection with a future meeting and/or
              showing; and (viii) they must notify the real estate licensee
              listed below if they become symptomatic and/or test positive for
              COVID-19 within 48 hours of the last visit to the property. The
              Broker represents that they use and present this Form uniformly
              and in the same manner for all in-person interactions and meetings
              and in accordance with all Federal, State and Local Fair Housing
              Laws.
            </p>
        ...
        <Row>
          <Col md={7} className="pl-4">
            <div class="pt-4">
              ...
              <div>
                <div class="form-check form-check-inline">
                  <input
                    ...
                    disabled={viewMode}
                    onChange={() =>
                      formik.setFieldValue("checkValueFirst", "true")
                    }
                  />
              ...
              {formik.touched.checkValueFirst &&
            ...
            <div class="pt-4">
              <p>
                <span>2.</span> Have you tested positive for COVID-19 in the
                past 14 days?
              </p>
              ...
              <div>
                <div class="form-check form-check-inline">
                  <input
                    ...
                    onChange={() =>
                      formik.setFieldValue("checkValueSecond", "true")
                    }
                    disabled={viewMode}
                  />
              ...
              {formik.touched.checkValueSecond &&
            ...
            <div class="pt-4">
              ...
              <div>
                <div class="form-check form-check-inline">
                  <input
                    ...
                    onChange={() =>
                      formik.setFieldValue("checkValueThird", "true")
                    }
                    disabled={viewMode}
                  />
                ...
                <div class="form-check form-check-inline">
                  <input
                    ...
                    onChange={() =>
                      formik.setFieldValue("checkValueThird", "false")
                    }
                    disabled={viewMode}
                  />
              ...
              {formik.touched.checkValueThird &&
            ...
            <div class="pt-4">
              <p>
                <span>4.</span> Are you fully vaccinated having completed your
                two-week immunity window following vaccination?
              </p>
              ...
              <div>
                <div class="form-check form-check-inline">
                  <input
                    ...
                    onChange={() =>
                      formik.setFieldValue("checkValueFourth", "true")
                    }
                    disabled={viewMode}
                  />
                ...
                <div class="form-check form-check-inline">
                  <input
                    ...
                    onChange={() =>
                      formik.setFieldValue("checkValueFourth", "false")
                    }
                    disabled={viewMode}
                  />
              ...
              {formik.touched.checkValueFourth &&
            ...
            <div>
              <div class="card mt-4">
                <p class="card-text mb-0 p-3">
                  ...
                  asymptomatic travelers entering New York from another country,
                  U.S. state or territory are no longer required to test or
                  quarantine as of April 10, 2021.
                </p>
                <p class="card-text p-3">
                  Please note that{" "}
                  <span>
                    PPE, social distancing and other protective protocols are
                ...
                <p class="card-text p-3">
                  REBNY’s Health Questionnaire Screening Form is a suggested
                  form, and therefore real estate licensees should continue to
                  use their best judgment as to whether they feel comfortable
                  showing property based on the information provided.
                </p>
              </div>
            </div>
          </Col>
        ...
        <Modal.Body className="draw-modal">
          ...
          {canvasShow && (
            <>
              ...
              <p style={{ paddingTop: 10, paddingLeft: 30 }}>
                I am {formik.values.fullName}and this is my legal representation
                of my Signature.
              </p>
          ...
          {fieldShow && (
            <>
              ...
              <p style={{ paddingTop: 10, paddingLeft: 30 }}>
                I am {formik.values.fullName} and this is my legal
