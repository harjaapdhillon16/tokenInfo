...
const Form2 = (formItem) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      realEstateCompany: Yup.string().required(
        "Please enter the Real Estate Company Name"
      ),
    ...
    <Container className="form2">
      ...
      <Row>
        <Col md={12}>
          ...
          <div className="pt-3">
            <p>
              Federal, State and local Fair Housing and Anti-discrimination Laws
              provide comprehensive protections from discrimination in housing.
              It is unlawful for any property owner, landlord, property manager
              or other person who sells, rents or leases housing, to
              discriminate based on certain protected characteristics, which
            ...
            <h6>
              ...
              you should file a complaint with the New York State Division of
              Human Rights (DHR). Complaints may be filed by:
            </h6>
            <ul>
              <li>
              ...
              <li>
                Stop by a DHR office in person, or contact one of the Division’s
                offices, by telephone or by mail, to obtain a complaint form
                and/or other assistance in filing a complaint. A list of office
            ...
            <p>
              You may also file a complaint with the NYS Department of State,
              Division of Licensing Services. Complaints may be filed by:
            </p>
            <ul>
              <li>
                Downloading a complaint form from the Department of State’s
                website
              ...
              <li>
                Stop by a Department’s office in person, or contact one of the
                Department’s offices, by telephone or by mail, to obtain a
                complaint form.
              </li>
              <li>Call the Department at (518) 474-4429.</li>
            </ul>
            <h6>
              There is no fee charged to you for these services. It is unlawful
              for anyone to retaliate against you for filing a complaint.
            </h6>
          </div>
        </Col>
      </Row>
      <Row className="pt-4">
        <Col md={12}>
          <h5>
            For more information on Fair Housing Act rights and responsibilities
            please visit
          </h5>
          <p>
            <a href="https://dhr.ny.gov/fairhousing">
          ...
          <form class="form-inline submit-form" onSubmit={formik.handleSubmit}>
            <ul class="form-inline">
              ...
              <li>
                (Buyer/Tenant/Seller/Landlord) acknowledge receipt of a copy of
                this
              </li>
